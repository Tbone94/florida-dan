...
const Music = (() => {
  ...
  function step(R, song, name, bar, st, t, s16, o = {}) {
    ...
    if (o.park && st % 2 === 0) I.calliope(R, t, N(ch.v[[0, 2, 1, 2, 3, 2, 1, 2][st / 2 % 8] % ch.v.length] + 12), st % 8 === 0 ? 1 : .6);   // Orlando: a tinny park calliope
  ...
  function pick(mood) {
    ...
    switch (mood) {
      ...
      case 'speed': return { key: 'speed' + mia + isl + par, song: base[0], bpm: 150, o: { fast: 1, ...io }, lp: 20000 };
      case 'slow': return { key: 'slow' + mia + isl + par, song: base[0], bpm: 84, o: { lofi: 1, swing: .22, island: isl ? 1 : 0, park: par ? 1 : 0 }, lp: 1300 };
      ...
      default: return { key: 'norm' + mia + isl + par, song: base[0], bpm: base[1], o: io, lp: 20000 };
    }
  }
