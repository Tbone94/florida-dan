...
const HEADLINES = [
  ...
  // ---- Orlando ----
  ['orlando', /ARRIVES IN ORLANDO/, 'Take the Greyhound to Orlando, after the Keys.'],
  ['timeshare', /90-MINUTE TIMESHARE PITCH/, 'Free tickets. Ninety minutes. Stay awake.'],
  ['parkEntry', /ENTERS SQUEAKYLAND IN JORTS/, 'The Happiest Place Within City Limits.'],
  ['turnstile', /HOPS SQUEAKYLAND TURNSTILE/, 'Tickets are $139. Legs are free.'],
  ['mouseBeer', /CHUGS BEER IN FRONT OF 300 CHILDREN/, 'Hug the mouse. Hug him TOO hard.'],
  ['mouseEscape', /MYSTERY MOUSE ESCAPES/, 'Fun Enforcement is looking for a mouse.'],
  ['mouseFast', /"MR\. SQUEAKY" CROSSES ENTIRE THEME PARK/, 'Get out of the park in under a minute. In the suit.'],
  ['orangeTree', /PUNCHES ORANGE TREE/, 'Trees respect punches.'],
  ['bigOrange', /FORMER MOUSE FINDS PEACE/, 'Kyle needs oranges.'],
  ['sirChomps', /"SIR CHOMPS"/, 'Todd from Ohio dropped his phone somewhere bad.'],
  ['whimsy', /WHIMSY LICENSE/, 'Win Case Ten.'],
  ['i4', /MOTORIZED COOLER DOWN I-4/, 'I-4 is a parking lot. The cooler has headlights.'],
  ['gangArrives', /ONE GREYHOUND/, 'Call everybody you know.'],
  ['motelFishFry', /FISH FRY AT MOTEL POOL/, 'Merle brought the turkey fryer. Of course he did.'],
  ['coasterCEO', /SHOTGUNNING BEER ON ROLLER COASTER/, 'Somebody important rides Space Squeak Mountain.'],
  ['coasterBarf', /BARFS ON SPACE SQUEAK MOUNTAIN/, 'Ride it drunk. Don’t.'],
  ['coaster3', /SPACE SQUEAK MOUNTAIN THREE TIMES/, 'Ride it again. And again.'],
  ['memo', /ONE \(1\) MEMO/, 'Squeaky HQ is in the castle. After dark.'],
  ['theEnd', /FLORIDA MAN ACT STRUCK DOWN/, 'Win the last case.'],
  ['finalParade', /GIANT COOLER FLOAT/, 'See it through to the very end.'],
  ['supportSystem', /ENTIRE SUPPORT SYSTEM/, 'Hang out with the whole gang at the motel.'],
  ['upsideDown', /UPSIDE-DOWN HOUSE/, 'I-Drive has a house on its roof.'],
  ['knights', /DINNER-SHOW KNIGHT/, 'Knights & Nuggets. Bring your own weapon.'],
  ['turkeyLeg', /GIANT TURKEY LEG/, 'Giant Discount Souvenir World sells a big bird leg.'],
  ['gigDucks', /DUCKS OFF VOLCANO/, 'Lava Larry has a duck problem.'],
  ['gigEarlyBird', /EARLY BIRD; BINGO/, 'Sunset Acres eats at 4:30.'],
  ['gigWrangle', /RETIREMENT COMMUNITY POND/, 'Wrangler Deb lost a gator.'],
  ['bo_noodle', /POOL NOODLE/, 'Black out in Orlando. (1/3)'],
  ['bo_orange', /HUGGING GIANT ORANGE/, 'Black out in Orlando. (2/3)'],
  ['bo_volcano', /INSIDE MINI GOLF VOLCANO/, 'Black out in Orlando. (3/3)'],
