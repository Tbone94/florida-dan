...
run $S/court1.mjs; run $S/court1.mjs desktop; run $S/gigs.mjs; run $S/up.mjs; run $S/tb2.mjs; run $S/seq.mjs; run $S/wanda.mjs; run $S/p2.mjs; run $S/dayt.mjs; run $S/dayt2.mjs; run $S/fixes.mjs; run $S/lambo.mjs; run $S/phone.mjs; run $S/phone.mjs mobile; run $S/flam.mjs; run $S/fixes2.mjs; run $S/keys.mjs; run $S/keys.mjs mobile; run $S/orlando.mjs; run $S/orlando.mjs mobile; run $S/arcs.mjs; run $S/scenes.mjs /tmp/fd-scenes; run $S/fullrun.mjs mobile; run $S/fullrun.mjs
exit $fail
